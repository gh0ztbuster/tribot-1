...
public class WorldHop {
    ...
    public static void setWorldColumnData() {
        ...
        if(allWorlds.size() > 68) { // pattern has shown if there are more than 68 worlds then they fit 18 worlds per column
            worldPixelStartX = 208;
            worldPixelStartY = 51;
            worldsPerColumn = 18;
            return;
        }
    ...
    public final static int[] getWorldsNotSupported() {
        ArrayList<Integer> worldsNotSupported = new ArrayList<Integer>();
    ...
    public static Rectangle getWorldClickArea(int world, int worldPerColumn, boolean checkExist) {
        ...
        if (x == -1 || y == -1) {
            ...
            int yR = worldPixelStartY + ((y - 1) * 24);
