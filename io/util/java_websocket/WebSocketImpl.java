...
import scripts.io.util.java_websocket.drafts.*;
...
import scripts.io.util.java_websocket.exceptions.WebsocketNotConnectedException;
import scripts.io.util.java_websocket.framing.CloseFrame;
import scripts.io.util.java_websocket.framing.CloseFrameBuilder;
import scripts.io.util.java_websocket.framing.Framedata;
import scripts.io.util.java_websocket.handshake.*;
import scripts.io.util.java_websocket.server.WebSocketServer;
