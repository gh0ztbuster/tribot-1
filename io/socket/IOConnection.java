...
import scripts.io.util.json.JSONException;
import scripts.io.util.json.JSONObject;
...
class IOConnection implements IOCallback {
	/** Debug logger */
	static final Logger logger = Logger.getLogger("scripts.socket");
	...
	public void transportMessage(String text) {
		System.out.println("Transport Message: " + text);
		//logger.info("< " + text);
		IOMessage message;
		try {
